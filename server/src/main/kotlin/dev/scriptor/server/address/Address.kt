...
fun parseAddressType(address: String): AddressType = when {
...
fun normalizeIpv4(address: String): String = address.split('.').joinToString(".") { it.toInt().toString() }
...
fun normalizeName(address: String): String = address.lowercase()
