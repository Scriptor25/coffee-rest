...
sealed class Signal(
    ...
    fun generate(): Result {
        ...
        return when (content) {
            ...
            is ReadableByteChannel -> ChannelResult(
                code,
                text,
                "application/octet-stream",
                headers,
